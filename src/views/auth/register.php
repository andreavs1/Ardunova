...
<div class="text-center mb-4">
  <img src="/assets/img/logo.jpg" alt="Logo" width="60" class="mb-2">
  <h1 class="h4 mb-0">Ardunova</h1>
  <p class="text-muted small">Creá tu cuenta</p>
</div>
...
<div class="text-center">
  <p class="text-muted small"> ¿Ya tenés una cuenta? <a href="/src/views/auth/login.php">¡Iniciá sesión!</a>
  </p>
</div>